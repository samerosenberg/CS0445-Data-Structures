...
public class SortArrayInstrumented {
     ...
     * @param n An integer > 0.
     */
    public  <T extends Comparable<? super T>> void insertionSort(T[] a, int n)
    {
        startStatistics();
     ...
     */
    private  <T extends Comparable<? super T>> void insertionSort(T[] a, int first, int last)
    {
        if (first < last)
        {
     ...
     * array entry to consider.
     */
    public  <T extends Comparable<? super T>> void insertInOrder(T anEntry, T[] a, int begin, int end)
    {
...
*/
     ...
     * @param n An integer > 0.
     */
    public  <T extends Comparable<? super T>> void shellSort(T[] a, int n) {
        shellSort(a, 0, n - 1);
    } // end shellSort
     ...
     * @param last An integer > first and < a.length.
     */
    public  <T extends Comparable<? super T>> void shellSort(T[] a, int first, int last) {
    ...
    @param space the difference between the indices of the
            entries to sort.
            */
    public  <T extends Comparable<? super T>> void incrementalInsertionSort(T[] a, int first, int last, int space) {
        int unsorted, index;
    ...
    public  <T extends Comparable<? super T>> void newSort(T[] a, int first, int last){
      int n = last - first + 1; // number of array entries
      int space = n/2;
      while (space > 0) {
        int unsorted, index;
