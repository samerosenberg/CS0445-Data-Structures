...
// equals bag[where]; otherwise, anEntry is not in the array
    ...
    public boolean equals(ArrayBag<T> aBag) {
        ...
        // This code is not the most efficient as it invoves multiple
    ...
    public void removeDuplicates() {
        ...
        for(int i=0;i<numberOfEntries;i++){
          for(int j=i+1;j<numberOfEntries;j++){
            if(bag[i]==bag[j]&& numberOfEntries>2){
              bag[j] = bag[numberOfEntries];
              removeEntry(numberOfEntries);
              j--;
           }
           else if(bag[i]==bag[j]&& numberOfEntries==2){
             removeEntry(j);
          }
          }
        }
